...
namespace DTO
{
    public class DTO_THAYTHEBANGLUONG
    {
        private int manv;
        ...
        public DTO_THAYTHEBANGLUONG()
        {
        }

        public DTO_THAYTHEBANGLUONG(int manv, string maluong, string maluongmoi, DateTime ngaysua, string lydo)
        {
            this.manv = manv;
