...
INSERT INTO PHANLOAITAIKHOAN(TENLOAITK, QUYENHAN) VALUES (N'Quản trị viên', N'Mọi thứ')
INSERT INTO PHANLOAITAIKHOAN(TENLOAITK, QUYENHAN) VALUES (N'Quản lý', N'Quản lý nv')
INSERT INTO PHANLOAITAIKHOAN(TENLOAITK, QUYENHAN) VALUES (N'Nhân viên', N'Cá nhân')
...
INSERT INTO HOSOTHUVIEC(HOTEN, NGAYSINH, GIOITINH, CMND_CCCD, NOICAP, VITRITHUVIEC, NGAYTV, SOTHANGTV, SDT, HOCVAN, GHICHU) VALUES ('Nguyễn Văn A', '01/01/2002', N'Nam', '123456789', 'BD', N'Editor', '01/10/2022', '5', '0123456789', N'Master', N'GHICHU')
INSERT INTO HOSOTHUVIEC(HOTEN, NGAYSINH, GIOITINH, CMND_CCCD, NOICAP, VITRITHUVIEC, NGAYTV, SOTHANGTV, SDT, HOCVAN, GHICHU) VALUES ('Nguyễn Thị B', '04/04/1999', N'Nữ', '987654321', 'BD', N'Content Maker', '01/10/2022', '5', '0123456789', N'Engineer', N'GHICHU')
...
INSERT INTO BANGLUONG(MALUONG, LCB, PHUCAPCHUCVU, PHUCAPKHAC) VALUES ('Luong03', 25000000, 2000000, 2000000)

INSERT INTO NHANVIEN(MAPHONG, MALUONG, HOTEN, NGAYSINH, GIOITINH, DANTOC, CMND_CCCD, NOICAP, CHUCVU, MALOAINV, LOAIHD, THOIGIAN, NGAYKY, NGAYHETHAN, SDT, HOCVAN, GHICHU) VALUES ('DS01', 'Luong02', 'New', '01/01/1995', N'Nữ', N'Kinh', '456789012', 'BD', N'Boss', 'BS', N'Dài hạn', '10', '01/01/2021', '01/01/2031', '0987456123', N'Master', N'GHICHU')
INSERT INTO NHANVIEN(MAPHONG, MALUONG, HOTEN, NGAYSINH, GIOITINH, DANTOC, CMND_CCCD, NOICAP, CHUCVU, MALOAINV, LOAIHD, THOIGIAN, NGAYKY, NGAYHETHAN, SDT, HOCVAN, GHICHU) VALUES ('IT01', 'Luong02', 'NGB', '05/11/2002', N'Nam', N'Kinh', '123456789', 'BD', N'Boss', 'BS', N'Dài hạn', '4', '01/01/2022', '01/01/2026', '0123456789', N'Master', N'GHICHU')
INSERT INTO NHANVIEN(MAPHONG, MALUONG, HOTEN, NGAYSINH, GIOITINH, DANTOC, CMND_CCCD, NOICAP, CHUCVU, MALOAINV, LOAIHD, THOIGIAN, NGAYKY, NGAYHETHAN, SDT, HOCVAN, GHICHU) VALUES ('IT02', 'Luong02', 'NHGH', '08/11/2002', N'Nam', N'Kinh', '2345678890', 'BD', N'Boss', 'BS', N'Dài hạn', '4', '01/01/2022', '01/01/2026', '0987654321', N'Master', N'GHICHU')
INSERT INTO NHANVIEN(MAPHONG, MALUONG, HOTEN, NGAYSINH, GIOITINH, DANTOC, CMND_CCCD, NOICAP, CHUCVU, MALOAINV, LOAIHD, THOIGIAN, NGAYKY, NGAYHETHAN, SDT, HOCVAN, GHICHU) VALUES ('DS02', 'Luong02', 'DDD', '05/06/2002', N'Nữ', N'Kinh', '345678901', 'BD', N'Boss', 'BS', N'Dài hạn', '4', '01/01/2022', '01/01/2026', '0987456321', N'Master', N'GHICHU')

INSERT INTO KHENTHUONG(TIEN, LYDO) VALUES (2000000, N'Thực hiện tốt nhiệm vụ dự án SOS')
...
INSERT INTO BANGCHAMCONG(MANV, THANG, NAM, MALUONG, TIENKHENTHUONG, TIENKYLUAT, SONGAYCONG, SONGAYNGHI, SOGIOLAMTHEM) VALUES (1, 10, 2022, 'Luong02', 10000000, 0, 26, 0, 24)
INSERT INTO BANGCHAMCONG(MANV, THANG, NAM, MALUONG, TIENKHENTHUONG, TIENKYLUAT, SONGAYCONG, SONGAYNGHI, SOGIOLAMTHEM) VALUES (2, 10, 2022, 'Luong02', 2000000, 0, 26, 0, 24)
INSERT INTO BANGCHAMCONG(MANV, THANG, NAM, MALUONG, TIENKHENTHUONG, TIENKYLUAT, SONGAYCONG, SONGAYNGHI, SOGIOLAMTHEM) VALUES (3, 10, 2022, 'Luong02', 2000000, 0, 26, 0, 0)
INSERT INTO BANGCHAMCONG(MANV, THANG, NAM, MALUONG, TIENKHENTHUONG, TIENKYLUAT, SONGAYCONG, SONGAYNGHI, SOGIOLAMTHEM) VALUES (4, 10, 2022, 'Luong02', 0, 500000, 25, 1, 9)

INSERT INTO LICHSUVANGMAT(MANV, NGAYNGHI) VALUES (4, 5/10/2022)

INSERT INTO SOTHAISAN(MANV, NGAYVESOM, NGAYNGHISINH, NGAYLAMTROLAI, TROCAPCTY) VALUES (4, 05/10/2021, 05/11/2021, 01/01/2022, 5000000)
...
INSERT INTO BANGTINHLUONG(MANV, LUONG, THANG, NAM) VALUES (2, 72960000, 10, 2022)
...
SELECT MANV, MAPHONG, MALUONG, HOTEN, FORMAT(NGAYSINH, 'dd/MM/yyyy') 'NGAYSINH', GIOITINH, DANTOC, CMND_CCCD, NOICAP, CHUCVU, MALOAINV, LOAIHD, THOIGIAN, FORMAT(NGAYKY, 'dd/MM/yyyy') 'NGAYKY',  FORMAT(NGAYHETHAN, 'dd/MM/yyyy') 'NGAYHETHAN', SDT, HOCVAN, GHICHU FROM NHANVIEN
SELECT MAPHONG, MABP, TENPHONG, FORMAT(NGAYTHANHLAP, 'dd/MM/yyyy') 'NGAYTHANHLAP', GHICHU FROM PHONGBAN
SELECT MABP, TENBOPHAN, FORMAT(NGAYTHANHLAP, 'dd/MM/yyyy') 'NGAYTHANHLAP', GHICHU FROM BOPHAN
SELECT MACS, MANV, LANCS, MAPHONG, MALUONG, HOTEN, FORMAT(NGAYSINH, 'dd/MM/yyyy') 'NGAYSINH', GIOITINH, DANTOC, CMND_CCCD, NOICAP, CHUCVU, MALOAINV, LOAIHD, THOIGIAN, FORMAT(NGAYKY, 'dd/MM/yyyy') 'NGAYKY',  FORMAT(NGAYHETHAN, 'dd/MM/yyyy') 'NGAYHETHAN', SDT, HOCVAN, GHICHU, FORMAT(NGAYCHINHSUA, 'dd/MM/yyyy') 'NGAYCHINHSUA' FROM LSCHINHSUA

SELECT BANGCHAMCONG.MANV, HOTEN, THANG, NAM, BANGCHAMCONG.MALUONG, TIENKHENTHUONG, TIENKYLUAT, SONGAYCONG, SONGAYNGHI, SOGIOLAMTHEM, BANGCHAMCONG.GHICHU FROM BANGCHAMCONG, NHANVIEN WHERE BANGCHAMCONG.MANV = NHANVIEN.MANV